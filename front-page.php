            ...
            <div class="hero-content">
                <div class="hero-left">
                    ...
                    <div class="special-offer">
                        ...
                        <div class="offer-price">₹<?php echo esc_html(ghar_ka_khana_get_option('offer_price', '69')); ?>!</div>
                    ...
                    <div class="delivery-info">
                        ...
                        <div class="delivery-text">
                            ...
                            <p>Free delivery available within <?php echo esc_html(ghar_ka_khana_get_option('delivery_areas', 'CBD Belapur Sectors 11-15, 19-23, and 29-31')); ?></p>
                        </div>
                    </div>

                    <!-- CTA Buttons -->
                    <div class="hero-buttons">
                        <a href="tel:<?php echo esc_attr(str_replace(' ', '', ghar_ka_khana_get_option('phone_number', '8108325444'))); ?>" class="btn-primary">
                            Order Now - ₹<?php echo esc_html(ghar_ka_khana_get_option('offer_price', '69')); ?>
                        </a>
                    ...
                    <div class="trust-indicators">
                        ...
                        <div class="trust-item">
                            <span class="trust-icon">📞</span>
                            <span><?php echo esc_html(ghar_ka_khana_get_option('phone_number', '8108 325 444')); ?></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="menu-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                <div class="menu-item" style="background: white; padding: 2rem; border-radius: 15px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                    <h3 style="color: #e74c3c; margin-bottom: 1rem;">Thali Special</h3>
                    <p style="color: #666; margin-bottom: 1rem;">Complete meal with rice, dal, sabzi, roti, and pickle</p>
                    <div style="font-size: 1.5rem; font-weight: bold; color: #333;">₹<?php echo esc_html(ghar_ka_khana_get_option('offer_price', '69')); ?></div>
                </div>
                
                <div class="menu-item" style="background: white; padding: 2rem; border-radius: 15px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                    <h3 style="color: #e74c3c; margin-bottom: 1rem;">North Indian</h3>
                    <p style="color: #666; margin-bottom: 1rem;">Authentic North Indian dishes with homely flavors</p>
                    <div style="font-size: 1.5rem; font-weight: bold; color: #333;">₹89</div>
                </div>
                
                <div class="menu-item" style="background: white; padding: 2rem; border-radius: 15px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                    <h3 style="color: #e74c3c; margin-bottom: 1rem;">South Indian</h3>
                    <p style="color: #666; margin-bottom: 1rem;">Traditional South Indian meals with sambar and rasam</p>
                    <div style="font-size: 1.5rem; font-weight: bold; color: #333;">₹79</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div style="text-align: center; max-width: 600px; margin: 0 auto;">
                ...
                <a href="tel:<?php echo esc_attr(str_replace(' ', '', ghar_ka_khana_get_option('phone_number', '8108325444'))); ?>" 
                   class="btn-primary" style="display: inline-block;">Call Now to Order</a>
            </div>
        </div>
    </section>
